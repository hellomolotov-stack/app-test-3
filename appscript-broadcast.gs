...
//   text       — текст сообщения, [имя] заменится на имя пользователя
//   segment    — кому слать:
//                  card_holders  — только владельцы карты (лист members)
//                  guests        — только гости (лист guests, allow_messages=yes)
//                  all           — все
//   startapp   — куда ведёт кнопка в сообщении:
//                  calendar             — 🗓 календарь событий
//                  card                 — 🪪 блок с картой
//                  updates              — 📰 блок обновлений
//                  summary              — 🧠 блок мастермайнда
//                  profiles             — 👤 раздел профилей
//                  hike_2026-06-07      — конкретное событие по дате
//                  bookings             — мои записи
