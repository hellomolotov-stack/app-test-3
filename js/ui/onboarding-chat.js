...
const FLOW = {
    ...
    relieved: {
        msgs: [() => lumenActive ? 'вот и хорошо 🤍\n\nпервый хайк – бесплатно. просто приходи' : 'вот и славно 🤍 тогда не откладывай – первый хайк бесплатный'],
        options: () => {
            const isMember = state.userCard?.status === 'active';
            return [
                { label: 'записаться на хайк 🏔', action: 'book' },
