...
export async function renderProfiles() {
    ...
    // Блюр-оверлей для гостей и владельцев без профиля
    ...
    // Градиент: от середины экрана вниз — блюр, выше — плавно в прозрачность
    blurOverlay.style.background = 'linear-gradient(to bottom, transparent 0%, transparent 50%, rgba(73, 138, 176, 0.1) 60%, rgba(73, 138, 176, 0.3) 100%)';
