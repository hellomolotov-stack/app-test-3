...
// Асинхронная загрузка профилей при открытии вкладки
export async function renderProfiles() {
    ...
    // Загружаем мой профиль, если есть
    if (myUserId) {
    ...
    // Кнопка "Мой профиль" в правом нижнем углу
    let editButtonHtml = '';
    if (currentMyProfile) {
    ...
    // Привязка событий к кнопкам контактов
    ...
    // Подсветка профиля, если мы пришли из списка участников
