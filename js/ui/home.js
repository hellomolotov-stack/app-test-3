...
import { renderIntelligentsiaRoutes, refreshIntelligentsiaRouteFavorites } from './intelligentsia-routes.js?v=20260917eklizirestore';
...
const GUEST_QA = [
    ...
    { q: 'когда последний раз делал что-то впервые?', btns: ['не помню…', 'давно'], a: 'запишись на хайк – билет 1000 ₽' },
