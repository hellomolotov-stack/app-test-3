...
const GUEST_QA = [
    ...
    { q: 'выходные = диван + сериал?', btns: ['ну да…', 'а что ещё?'], a: 'горы не покажут по Netflix' },
    { q: 'все вокруг куда-то бегут, а ты стоишь?', btns: ['знакомо', 'и что?'], a: 'мы идём. в горы. медленно' },
    { q: 'скучно с теми, кто всё время жалуется?', btns: ['очень', 'бесит'], a: 'у нас жалуются только на погоду' },
    ...
    { q: 'чувствуешь, что застрял?', btns: ['есть такое', 'немного'], a: 'на высоте 1200м застрять сложно' },
];
