...
function showBottomSheet(index) {
    ...
    overlay.innerHTML = `
        <div class="bottom-sheet" id="hikeBottomSheet">
            <div class="bottom-sheet-grab-area">
    ...
    const grabArea = sheet.querySelector('.bottom-sheet-grab-area');
    ...
    grabArea.addEventListener('touchstart', onTouchStart, { passive: false });
    grabArea.addEventListener('touchmove', onTouchMove, { passive: false });
    grabArea.addEventListener('touchend', onTouchEnd, { passive: false });
    grabArea.addEventListener('touchcancel', onTouchEnd, { passive: false });
